...
public class AdminAddVehicle extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (DateCheck == true) {
            Car c = new Car(AvailableInput.isSelected(), Integer.parseInt(PriceInput.getText()), DateInput.getText(), null, MakeInput.getText(), ModelInput.getText(), RegistrationInput.getText());
            NotificationText.setText("You have successfully added this new car.");
            ArrayList<Car> newCarList = VehicleManager.getInstance().getCarList();
            newCarList.add(c);
            VehicleManager.getInstance().setCarList(newCarList);            
        }
